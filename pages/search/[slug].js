          ...
          <div className="lg:grid lg:grid-cols-12 lg:auto-rows-min lg:gap-x-8">
            ...
            <div className="mt-8 lg:col-span-5">
                  ...
                  <div className="flex justify-between items-end pt-5">
                    <div className="ml-1 flex items-center">
                      ...
                      <p className="flex items-center">
                        <span className="sr-only"> ocene od 5 zvezdica</span>
                      </p>{" "}
                    </div>
                  </div>
                </div>
             ...
             text-white hover:bg-red-300 hover:scale-95"
              ...
              {/* Product details */}
              <div className="mt-10 text-gray-500">{product.description}</div>

              <div className="mt-8 border-t border-gray-200 pt-8">
                <div className="mt-4 prose prose-sm text-gray-500"></div>
              </div>
          ...
          <section aria-labelledby="related-heading" className="mt-16 sm:mt-24">
            ...
            <div className="mt-6 grid grid-cols-1  gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
              {allProducts.products
                .filter((product) =>
                  product.location.toLowerCase().includes("london")
                )
                .map((relatedProduct) => (
                  <div
                    key={relatedProduct.id}
                    className="group relative border bg-red-100 rounded-md p-4"
                  >
                    ...
                    <div className="mt-4 flex justify-between">
                      <div>
                        <h3 className="text-sm text-gray-700">
                          <Link
                            href={`/search/${relatedProduct.slug}`}
                            passHref
                          >
                            <div>
                              <span
