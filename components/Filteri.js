...
const filters = {
    price: [
      { value: '0', label: '0-2000EUR', checked: false },
        ...
        <Disclosure.Panel className="border-t border-gray-200 py-10">
          <div className="max-w-7xl mx-auto grid grid-cols-2 gap-x-4 px-4 text-sm sm:px-6 md:gap-x-6 lg:px-8">
            <div className="grid grid-cols-1 gap-y-10 auto-rows-min md:grid-cols-2 md:gap-x-6">
              <fieldset>
                <legend className="block font-medium">Cena</legend>
        ...
        <div className="col-start-1 row-start-1 py-4">
          <div className="flex justify-end max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <Menu as="div" className="relative inline-block">
              ...
              >
                <Menu.Items className="origin-top-right absolute right-0 mt-2 p-2 w-40 rounded-md shadow-2xl bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                  <div className="py-1">
                        ...
                        {({ active }) => (
                          <a
                            ...
                            className={classNames =>(
                              option.current ? 'font-medium text-gray-900 p-2' : 'text-gray-500 ',
                              active ? 'bg-gray-100' : '',
