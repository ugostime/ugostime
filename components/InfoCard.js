...
const InfoCard = ({
  ...
  return (
    ...
    <div key={product.id} className="flex flex-col sm:flex-row py-7 px-2 border-b cursor-pointer hover:opacity-80 hover:shadow-lg transition transform duration-200 ease-out first:border-t last:mb-8 rounded-b-xl">
      ...
      <div
      className="relative mb-2 h-48 sm:h-52 w-full sm:w-80 flex-shrink-0 flex items-center justify-center ">
        <img 
          src={product.img}
          layout="fill"
          objectFit="cover"
      ...
      <div className="flex flex-col flex-grow pl-5">
        ...
        <p className="pt-2 text-sm text-gray-500 flex-grow">{product.description}</p>
        <div className="flex justify-between items-end pt-5">
          ...
          <div>
            <p className="text-lg lg:text-2xl font-semibold pb-2">{product.price}</p>
