...
function RegistrationForm() {
    ...
    <h2 className="text-2xl text-center font-serif font-semibold grid-flow-col-dense p-5" >Ugosti.me</h2>
          ...
          <div className="mt-8">
            <div>
              <div>
                <p className="text-sm font-medium text-gray-700">Prijavi se putem naloga</p>
                ...
                <div className="mt-1 grid grid-cols-3 gap-3">
                  <div>
                    ...
                    >
                      <span className="sr-only">Prijavi se putem Facebook-a</span>
                      <div>
                  ...
                  <div>
                    <a
                      ...
                      className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-full shadow-sm bg-white text-sm font-medium text-red-400 hover:bg-gray-50"
                    >
                      <span className="sr-only">Prijavi se preko Twitter-a</span>
                     <div>
              ...
              <div className="mt-6 relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-gray-500">Ili nastavi</span>
                </div>
              </div>
            </div>
